...
describe('Appointments', () => {
  ...
  it('POST', (done) => {
    mock.onPost('/http://www.example.com/appointments',
      {start_at: '2001-09-23', agenda_id: '2135', state: 'true'}).reply(200, {
  ...
  it('PUT', (done) => {
    mock.onPut('/http://www.example.com/appointments/21354.json', {start_at: '2001-09-23', agenda_id: '2135'}).reply(200, {
      start_at: '2017-09-18T17:30:00.000+02:00',
      duration: 1800,
      state: 'confirmed',
      agenda_id: 552,
  ...
  it('DELETE', (done) => {
    ...
    instance.appointments.delete(21321, {}).then((response) => {
      expect(response.status).toEqual(200);
      done();
    });
  });
