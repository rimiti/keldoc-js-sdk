...
describe('API Exceptions', () => {
  ...
  it('should throw Bad Request exception when response status equal to 400', (done) => {
    mock.onPost('http://www.example.com/partners/appointments', {start_at: '20010923', agenda_id: '2135', state: 'true'})
      .reply(400);
  ...
  it('should throws Unknown error for get request', (done) => {
    mock.onGet('http://www.example.com/partners/agendas').reply(100, [{id: 1, name: 'Dr. KelDoc test'}]);
  ...
  it('should throws Unknown error for delete request', (done) => {
    mock.onDelete('http://www.example.com/partners/config/webhooks').reply(100);
